...
#[derive(Debug)]
pub struct GreenLeafProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GreenLeafProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GreenLeaf processing");
    
    let mut processor = GreenLeafProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GreenLeafProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GreenLeafProcessor::new(false);
